...
namespace InstrumentStore
{
    class TestProgram
    {
        static void Main(string[] args)
        {
            ...
            var whatByranLikes = new InstrumentSpec(properties);

            var matchingInstruments = inventory.SearchInstruments(whatByranLikes);
            if (matchingInstruments.Any())
            {
                Console.WriteLine("Byran, you might like these instruments:");
            ...
            else Console.WriteLine("Sorry Byran, we have nothign for you.");
